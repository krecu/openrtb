...
func easyjson89fe9b30DecodeGithubComKrecuOpenrtb(in *jlexer.Lexer, out *BidRequest) {
	...
	for !in.IsDelim('}') {
		...
		case "imp":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v1 Impression
					easyjson89fe9b30DecodeGithubComKrecuOpenrtb1(in, &v1)
		...
		case "site":
			if in.IsNull() {
				...
				easyjson89fe9b30DecodeGithubComKrecuOpenrtb2(in, &*out.Site)
			}
		case "app":
			if in.IsNull() {
				in.Skip()
				...
				easyjson89fe9b30DecodeGithubComKrecuOpenrtb3(in, &*out.App)
			}
		case "device":
			if in.IsNull() {
				in.Skip()
				...
				easyjson89fe9b30DecodeGithubComKrecuOpenrtb4(in, &*out.Device)
			}
		case "user":
			if in.IsNull() {
				in.Skip()
				...
				easyjson89fe9b30DecodeGithubComKrecuOpenrtb5(in, &*out.User)
			}
		case "test":
			out.Test = int(in.Int())
		case "at":
		...
		case "source":
			if in.IsNull() {
				...
				easyjson89fe9b30DecodeGithubComKrecuOpenrtb6(in, &*out.Source)
			}
		case "regs":
			if in.IsNull() {
				in.Skip()
				...
				easyjson89fe9b30DecodeGithubComKrecuOpenrtb7(in, &*out.Regs)
			}
		case "ext":
		...
		case "pmp":
			if in.IsNull() {
				...
				easyjson89fe9b30DecodeGithubComKrecuOpenrtb8(in, &*out.Pmp)
			}
		default:
			in.SkipRecursive()
		}
...
func easyjson89fe9b30EncodeGithubComKrecuOpenrtb(out *jwriter.Writer, in BidRequest) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	if len(in.Imp) != 0 {
		...
		}
		{
			...
			for v9, v10 := range in.Imp {
				...
				easyjson89fe9b30EncodeGithubComKrecuOpenrtb1(out, v10)
			}
			out.RawByte(']')
		}
	}
	if in.Site != nil {
		...
		easyjson89fe9b30EncodeGithubComKrecuOpenrtb2(out, *in.Site)
	}
	if in.App != nil {
		...
		easyjson89fe9b30EncodeGithubComKrecuOpenrtb3(out, *in.App)
	}
	if in.Device != nil {
		...
		easyjson89fe9b30EncodeGithubComKrecuOpenrtb4(out, *in.Device)
	}
	if in.User != nil {
		...
		easyjson89fe9b30EncodeGithubComKrecuOpenrtb5(out, *in.User)
	}
	if in.Test != 0 {
	...
	if in.Source != nil {
		...
		easyjson89fe9b30EncodeGithubComKrecuOpenrtb6(out, *in.Source)
	}
	if in.Regs != nil {
		...
		easyjson89fe9b30EncodeGithubComKrecuOpenrtb7(out, *in.Regs)
	}
	if len(in.Ext) != 0 {
	...
	if in.Pmp != nil {
		...
		easyjson89fe9b30EncodeGithubComKrecuOpenrtb8(out, *in.Pmp)
	}
	out.RawByte('}')
}
...
func (v BidRequest) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson89fe9b30EncodeGithubComKrecuOpenrtb(&w, v)
...
func (v *BidRequest) UnmarshalJSON(data []byte) error {
	...
	easyjson89fe9b30DecodeGithubComKrecuOpenrtb(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *BidRequest) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson89fe9b30DecodeGithubComKrecuOpenrtb(l, v)
}
func easyjson89fe9b30DecodeGithubComKrecuOpenrtb8(in *jlexer.Lexer, out *Pmp) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson89fe9b30EncodeGithubComKrecuOpenrtb8(out *jwriter.Writer, in Pmp) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Private != 0 {
...
func easyjson89fe9b30DecodeGithubComKrecuOpenrtb7(in *jlexer.Lexer, out *Regulations) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson89fe9b30EncodeGithubComKrecuOpenrtb7(out *jwriter.Writer, in Regulations) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Coppa != 0 {
...
func easyjson89fe9b30DecodeGithubComKrecuOpenrtb6(in *jlexer.Lexer, out *Source) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson89fe9b30EncodeGithubComKrecuOpenrtb6(out *jwriter.Writer, in Source) {
	out.RawByte('{')
	first := true
	_ = first
...
func easyjson89fe9b30DecodeGithubComKrecuOpenrtb5(in *jlexer.Lexer, out *User) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "geo":
			if in.IsNull() {
				...
				easyjson89fe9b30DecodeGithubComKrecuOpenrtb9(in, &*out.Geo)
			}
		case "data":
			if in.IsNull() {
				in.Skip()
				...
				for !in.IsDelim(']') {
					var v28 Data
					easyjson89fe9b30DecodeGithubComKrecuOpenrtb10(in, &v28)
...
func easyjson89fe9b30EncodeGithubComKrecuOpenrtb5(out *jwriter.Writer, in User) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != "" {
	...
	if in.Geo != nil {
		...
		easyjson89fe9b30EncodeGithubComKrecuOpenrtb9(out, *in.Geo)
	}
	if len(in.Data) != 0 {
		...
		}
		{
			...
			for v29, v30 := range in.Data {
				...
				easyjson89fe9b30EncodeGithubComKrecuOpenrtb10(out, v30)
			}
			out.RawByte(']')
		}
	}
...
func easyjson89fe9b30DecodeGithubComKrecuOpenrtb10(in *jlexer.Lexer, out *Data) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "segment":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v31 Segment
					easyjson89fe9b30DecodeGithubComKrecuOpenrtb11(in, &v31)
...
func easyjson89fe9b30EncodeGithubComKrecuOpenrtb10(out *jwriter.Writer, in Data) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != "" {
	...
	if len(in.Segment) != 0 {
		...
		}
		{
			...
			for v32, v33 := range in.Segment {
				...
				easyjson89fe9b30EncodeGithubComKrecuOpenrtb11(out, v33)
			}
			out.RawByte(']')
		}
	}
...
func easyjson89fe9b30DecodeGithubComKrecuOpenrtb11(in *jlexer.Lexer, out *Segment) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson89fe9b30EncodeGithubComKrecuOpenrtb11(out *jwriter.Writer, in Segment) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != "" {
...
func easyjson89fe9b30DecodeGithubComKrecuOpenrtb9(in *jlexer.Lexer, out *Geo) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson89fe9b30EncodeGithubComKrecuOpenrtb9(out *jwriter.Writer, in Geo) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Lat != 0 {
...
func easyjson89fe9b30DecodeGithubComKrecuOpenrtb4(in *jlexer.Lexer, out *Device) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson89fe9b30EncodeGithubComKrecuOpenrtb4(out *jwriter.Writer, in Device) {
	out.RawByte('{')
	first := true
	_ = first
	if in.UA != "" {
...
func easyjson89fe9b30DecodeGithubComKrecuOpenrtb3(in *jlexer.Lexer, out *App) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "publisher":
			if in.IsNull() {
				...
				easyjson89fe9b30DecodeGithubComKrecuOpenrtb12(in, &*out.Publisher)
			}
		case "content":
			if in.IsNull() {
				in.Skip()
				...
				easyjson89fe9b30DecodeGithubComKrecuOpenrtb13(in, &*out.Content)
			}
		case "keywords":
			out.Keywords = string(in.String())
		case "ext":
...
func easyjson89fe9b30EncodeGithubComKrecuOpenrtb3(out *jwriter.Writer, in App) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Bundle != "" {
	...
	if in.Publisher != nil {
		...
		easyjson89fe9b30EncodeGithubComKrecuOpenrtb12(out, *in.Publisher)
	}
	if in.Content != nil {
		...
		easyjson89fe9b30EncodeGithubComKrecuOpenrtb13(out, *in.Content)
	}
	if in.Keywords != "" {
		const prefix string = ",\"keywords\":"
		if first {
...
func easyjson89fe9b30DecodeGithubComKrecuOpenrtb13(in *jlexer.Lexer, out *Content) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "producer":
			if in.IsNull() {
				...
				easyjson89fe9b30DecodeGithubComKrecuOpenrtb14(in, &*out.Producer)
			}
		case "url":
		...
		case "data":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v44 Data
					easyjson89fe9b30DecodeGithubComKrecuOpenrtb10(in, &v44)
...
func easyjson89fe9b30EncodeGithubComKrecuOpenrtb13(out *jwriter.Writer, in Content) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != "" {
	...
	if in.Producer != nil {
		...
		easyjson89fe9b30EncodeGithubComKrecuOpenrtb14(out, *in.Producer)
	}
	if in.URL != "" {
	...
	if len(in.Data) != 0 {
		...
		}
		{
			...
			for v47, v48 := range in.Data {
				...
				easyjson89fe9b30EncodeGithubComKrecuOpenrtb10(out, v48)
			}
			out.RawByte(']')
		}
	}
...
func easyjson89fe9b30DecodeGithubComKrecuOpenrtb14(in *jlexer.Lexer, out *Producer) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson89fe9b30EncodeGithubComKrecuOpenrtb14(out *jwriter.Writer, in Producer) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != "" {
...
func easyjson89fe9b30DecodeGithubComKrecuOpenrtb12(in *jlexer.Lexer, out *Publisher) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson89fe9b30EncodeGithubComKrecuOpenrtb12(out *jwriter.Writer, in Publisher) {
	out.RawByte('{')
	first := true
	_ = first
	if in.ID != "" {
...
func easyjson89fe9b30DecodeGithubComKrecuOpenrtb2(in *jlexer.Lexer, out *Site) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson89fe9b30EncodeGithubComKrecuOpenrtb2(out *jwriter.Writer, in Site) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Page != "" {
...
func easyjson89fe9b30DecodeGithubComKrecuOpenrtb1(in *jlexer.Lexer, out *Impression) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "banner":
			if in.IsNull() {
				...
				easyjson89fe9b30DecodeGithubComKrecuOpenrtb15(in, &*out.Banner)
			}
		case "video":
			if in.IsNull() {
				in.Skip()
		...
		case "native":
			if in.IsNull() {
				...
				easyjson89fe9b30DecodeGithubComKrecuOpenrtb16(in, &*out.Native)
			}
		case "pmp":
			if in.IsNull() {
				in.Skip()
...
func easyjson89fe9b30EncodeGithubComKrecuOpenrtb1(out *jwriter.Writer, in Impression) {
	out.RawByte('{')
	first := true
	_ = first
	{
	...
	if in.Banner != nil {
		...
		easyjson89fe9b30EncodeGithubComKrecuOpenrtb15(out, *in.Banner)
	}
	if in.Video != nil {
	...
	if in.Native != nil {
		...
		easyjson89fe9b30EncodeGithubComKrecuOpenrtb16(out, *in.Native)
	}
	if in.Pmp != nil {
		const prefix string = ",\"pmp\":"
		if first {
...
func easyjson89fe9b30DecodeGithubComKrecuOpenrtb16(in *jlexer.Lexer, out *Native) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson89fe9b30EncodeGithubComKrecuOpenrtb16(out *jwriter.Writer, in Native) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func easyjson89fe9b30DecodeGithubComKrecuOpenrtb15(in *jlexer.Lexer, out *Banner) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
	...
	for !in.IsDelim('}') {
		...
		case "format":
			if in.IsNull() {
				...
				for !in.IsDelim(']') {
					var v73 Format
					easyjson89fe9b30DecodeGithubComKrecuOpenrtb17(in, &v73)
...
func easyjson89fe9b30EncodeGithubComKrecuOpenrtb15(out *jwriter.Writer, in Banner) {
	out.RawByte('{')
	first := true
	_ = first
	if in.W != 0 {
	...
	if len(in.Format) != 0 {
		...
		}
		{
			...
			for v79, v80 := range in.Format {
				...
				easyjson89fe9b30EncodeGithubComKrecuOpenrtb17(out, v80)
			}
			out.RawByte(']')
		}
	}
...
func easyjson89fe9b30DecodeGithubComKrecuOpenrtb17(in *jlexer.Lexer, out *Format) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson89fe9b30EncodeGithubComKrecuOpenrtb17(out *jwriter.Writer, in Format) {
	out.RawByte('{')
	first := true
	_ = first
	if in.W != 0 {
